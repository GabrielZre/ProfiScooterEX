...
import com.example.profiscooterex.ui.destinations.DirectionDestination
...
enum class BottomBarItem(
    ...
    Home(HomeScreenDestination, Icons.Default.List, R.string.home),
    Login(LoginScreenDestination, Icons.Default.Person, R.string.login),
}