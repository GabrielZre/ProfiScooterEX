...
fun BatteryIcon(
    ...
    val bluetoothTint =
        determineBluetoothTint(bleConnectionState, isBluetoothEnabled, bluetoothPermissionsState)
    val batteryIcon =
    ...
    Box(modifier = Modifier.width(IntrinsicSize.Min), contentAlignment = Alignment.Center) {
        ...
        if (
            ...
            Icon(
                ...
                tint = bluetoothTint,
                modifier = Modifier.size(28.dp).graphicsLayer(alpha = 0.6f)
            )
        }
    }
}
